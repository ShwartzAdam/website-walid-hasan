...
export const inventory: InventoryItem[] = [
  ...
  },
  {
    id: "R-album-salit",
    category: "Projects",
    item: "Album \"פרויקט- סלעית שלב ג' - יזם אמפא ישראל\" (9 photos, Jan 2020)",
    status: "web",
    source: "Company Facebook page — albums",
    url: "https://www.facebook.com/100063619101665/",
    dateFound: "2026-09-25",
    whatItProves: "Sal'it Phase C for Amfa Israel; drone photos before and after the works",
    usagePermission: "requested",
    confidence: "high",
    relatedProject: "salit-c",
    finalStatus: "Project page shown as NEEDS_CONFIRMATION with GENERATED illustration — album originals requested",
  },
  {
    id: "R-album-nofei-nehemia",
    category: "Projects",
    item: "Album \"פרויקט - נופי נחמיה 14 יח\"ד יזם - אמנה\" (12 photos, Dec 2019 – Jan 2020)",
    status: "web",
    source: "Company Facebook page — albums",
    url: "https://www.facebook.com/100063619101665/",
    dateFound: "2026-09-25",
    whatItProves: "14-unit compound in Nofei Nehemia for Amana; works in progress and drone of the finished compound",
    usagePermission: "requested",
    confidence: "high",
    relatedProject: "nofei-nehemia",
    finalStatus: "Project page shown as NEEDS_CONFIRMATION with GENERATED illustration — album originals requested",
  },
  {
    id: "R-album-bruchin",
    category: "Projects",
    item: "Album \"פרויקט - ברוכין שלב ג' - יזם אמנה\" (7 photos) and post \"עבודות בברוכין פרויקט אמנה\"",
    status: "web",
    source: "Company Facebook page — albums",
    url: "https://www.facebook.com/100063619101665/posts/100757044734540/",
    dateFound: "2026-09-25",
    whatItProves: "Bruchin Phase C for Amana",
    usagePermission: "requested",
    confidence: "high",
